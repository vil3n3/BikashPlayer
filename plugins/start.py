...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "inf":
            ...
            searched_text = f"""
__**🌷 ​USER-𓆰ꪜ𝓲ꪶꪶ𝓲ꪖꪀ𓆪 𝐕𝐢𝐝𝐞𝐨 𝐓𝐫𝐚𝐜𝐤 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧 🌷**__
...
🔍️ 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 🌷 {config.MUSIC_BOT_NAME}__"""
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    ...
                    f"{message.from_user.mention} 𝐇𝐚𝐬 𝐉𝐮𝐬𝐭 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 USER-𓆰ꪜ𝓲ꪶꪶ𝓲ꪖꪀ𓆪 𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 🎵  𝐓𝐨 𝐂𝐡𝐞𝐜𝐤 <code>🥀 𝐕𝐢𝐝𝐞𝐨 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧</code>\n\n**🆔 𝐔𝐬𝐞𝐫 𝐈𝐝:** {sender_id}\n**👑 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞:** {sender_name}",
                )
    else:
        try:
        ...
        photo=f"https://graph.org/file/6edbec3eac70b422b8669.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 𝐇𝐞𝐥𝐥𝐨, 𝐈 𝐚𝐦 𝐒𝐮𝐩𝐞𝐫𝐟𝐚𝐬𝐭 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲
𝐍𝐨 𝐋𝐚𝐠 𝐕𝐂 𝐌𝐮𝐬𝐢𝐜 𝐏𝐥𝐚𝐲𝐞𝐫 𝐁𝐨𝐭.

┏━━━━━━━━━━━━━━━━━┓
┣★ 𝐎𝐰𝐧𝐞𝐫'𝐱𝐃 : [ꪜ𝓲ꪶꪶ𝓲ꪖꪀ 𝐴𝑠𝑠𝑖𝑠𝑡𝑎𝑛𝑡](https://t.me/vilen_3r)
┣★ 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 » : [​𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥](https://t.me/villen_012)
┣★ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 » : [ 𝐂𝐡𝐚𝐭 ](https://t.me/HLV_NETWORK)
┗━━━━━━━━━━━━━━━━━┛
